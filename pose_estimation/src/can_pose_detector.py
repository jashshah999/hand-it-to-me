...
class CircleDetector:
    ...
    def __init__(self):
        rospy.init_node('can_detection', anonymous=True)
        self.bridge = CvBridge()
        self.min_radius = 30
        self.max_radius = 35
        self.threshold = 50
        self.min_distance = 30
        self.output_pub = rospy.Publisher('/can_pose', PoseStamped, queue_size=1)
    ...
    def image_callback(self, msg):
        ...
        self.can_top_pose = get_can_pose(frame,self.queue_pose_x, self.queue_pose_y,self.queue_radius,self.min_radius,self.max_radius,self.threshold,self.min_distance,self.pose_msg)
